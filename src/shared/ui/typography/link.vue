...
<template>
  <a
    :href="href"
    class="relative inline-block transition text-black hover:text-primary align-top uppercase font-montserrat text-[13px] px-[24px] tracking-[.19em] leading-[23px] font-medium cursor-pointer"
